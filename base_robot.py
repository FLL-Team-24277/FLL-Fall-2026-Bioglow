...
class BaseRobot:
    ...
    def __init__(self):
        ...
        # Keep this mapping aligned with self.sensorColors so active mission
        # colors are clear and easier to debug.
    ...
    def curve(
        ...
        radius (REQUIRED, integer): How tight of a curve. POS = right; \
        NEG = left
    ...
    def driveArcDist(
        ...
        Positive = arc to the right, negative = arc to the left.

        dist (REQUIRED integer): Distance to drive along the arc in mm. \
        Positive = forward, negative = backward.

        speedPct: (OPTIONAL integer, 1 to 100): Controls how fast \
        the robot drives.
